...
// File: contracts/AccbyToken.sol

pragma solidity ^0.4.24;

/*
 * AccbyToken is a standard ERC20 token with some additional functionalities:
...
contract AccbyToken is StandardToken, BurnableToken, Ownable {
	string public constant symbol = "ACCBY";
	string public constant name = "ACCBY";
	uint8 public constant decimals = 18;
	uint256 public constant INITIAL_SUPPLY = 5000000000 * (10 ** uint256(decimals));
	uint256 public constant TOKEN_OFFERING_ALLOWANCE = 2000000000 * (10 ** uint256(decimals));
	...
	*/
	function AccbyToken(address admin) public {
	...
	* @param value Amount of accbytokens to send
	*/
